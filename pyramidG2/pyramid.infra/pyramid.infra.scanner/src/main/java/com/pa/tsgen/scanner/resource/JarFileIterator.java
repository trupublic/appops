...
package com.pa.tsgen.scanner.resource;
...
import com.pa.tsgen.scanner.Filter;
...
public final class JarFileIterator implements ResourceIterator {
    ...
    /* @see com.pa.tsgen.scanner.resource.ResourceIterator#next() */
    @Override
    ...
    /* @see com.pa.tsgen.scanner.resource.ResourceIterator#close() */
    @Override
    public void close() {
        try {
            closed = true;
